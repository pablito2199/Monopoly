...
public final class Sombrero extends Avatar {
    private boolean movimientoespecialsombrero;
    ...
    public Sombrero() {
        this.movimientoespecialsombrero = false;
    ...
    public boolean isMovimientoespecialsombrero() {
        return movimientoespecialsombrero;
    }

    public void setMovimientoespecialsombrero(boolean movimientoespecialsombrero) {
        this.movimientoespecialsombrero = movimientoespecialsombrero;
    }
    ...
    public void impAvatar(String id) {
        ...
        Juego.consola.imprimirln("tipo: Sombrero,");
