...
public final class AccionComunidad extends Accion {
    public AccionComunidad(ArrayList<Suerte> suerte) {
        super(suerte);
    }

    public AccionComunidad(String nombre, double coste, String color, int posicion) {
    ...
    public void eleccioncomunidad(Tablero tablero, Avatar avatartirada) throws SinDinero {
        String numero;
        do {
        ...
        super.BarajarComunidad();
        Carta carta = getComunidad().get(Integer.parseInt(numero) - 1);
